...
class BuiltInFormFieldsScreen extends StatefulWidget {
  @override
  _BuiltInFormFieldsScreenState createState() =>
      _BuiltInFormFieldsScreenState();
}

class _BuiltInFormFieldsScreenState extends State<BuiltInFormFieldsScreen> {
  int _currentIndex = 0;
